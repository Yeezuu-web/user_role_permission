                            ...
                            <table
                              ...
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                  ...
                                  <p
                                    ...
                                    <span style="font-size:19px"><strong>{{ $details['title'] }}<br></strong></span><br>You
                                    received Facebook Boosting Request from {{ $details['company'] }} for Brand {{ $details['brand'] }} @ amount USD {{ $details['budget'] }}. 
                                    @if ($details['action'] != 'review')
                                    This request already reviewed by {{ $details['review_by'] }}  
                                    @endif
                                    Please click the link below for detail information and {{ $details['action'] }}:</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td align="center"
                                  ...
                                  <span class="es-button-border"
                                    style="border-style:solid;border-color:#FFA73B;background:#fe4f4a;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                              ...
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                    <b>Thanks and Regards,</b></p>
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#666666;font-size:16px">
                                    CBS Digital</p>
                                </td>
                              </tr>
                            </table>
